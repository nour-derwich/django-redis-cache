"""
Django settings for Redis Caching Demo project.
Advanced configuration with multiple caching strategies.
"""
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgresql://postgres:postgres@db:5432/redis_demo'),
        conn_max_age=600,
...
# Cache Configuration - Multiple Strategies
CACHES = {
    'default': {
    ...
    'session': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': os.environ.get('REDIS_URL', 'redis://:redispass@redis:6379/3'),
        'OPTIONS': {
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Django Redis Caching Demo API',
    'DESCRIPTION': 'Advanced Redis caching patterns with Django REST Framework',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
}

# Celery Configuration
CELERY_BROKER_URL = os.environ.get('CELERY_BROKER_URL', 'redis://:redispass@redis:6379/1')
CELERY_RESULT_BACKEND = os.environ.get('CELERY_RESULT_BACKEND', 'redis://:redispass@redis:6379/2')
